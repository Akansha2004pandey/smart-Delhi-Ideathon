...
const Complain = () => {
    ...
    return (
        <>
        <div className="flex justify-center items-center gap-3"><AlarmCheck className='bg-red-600 font-bold w-10 h-10 text-white text-3xl rounded lg'/> <div className='text-3xl text-white font-extrabold text-center'>Raise a Complaint</div></div>
